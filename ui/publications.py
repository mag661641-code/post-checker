...
Проверяет площадки (Telegram, ВКонтакте, Одноклассники, Max, Дзен) и честно
показывает, что именно проверено: текст сверился, страница лишь
...
# WhatsApp не используем — в реестр не выкладываем, поэтому его нет в списке.
COLS = ["Telegram", "ВКонтакте", "Одноклассники", "Max", "Дзен"]
